<!DOCTYPE html>
   ...
   <body>
      <div class="login">
         ...
         <form action="<?= site_url('Login/register') ?>" method="post" class="login__form">
            ...
            <div class="login__box">
               ...
               <div class="login__box">
                  <input type="password" name="password_lagi" placeholder="Password" required class="login__input">
                  <i class="ri-lock-2-fill"></i>
               </div>
            </div>
